...
namespace DiReCT_wf {
    ...
    public partial class MainWorkFlow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(MainWorkFlow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(MainWorkFlow));
        ...
        private string FindResource() {
            string[] resources = typeof(MainWorkFlow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".MainWorkFlow.g.xaml") || resource.Equals("MainWorkFlow.g.xaml"))) {
                    return resource;
                }
            }
