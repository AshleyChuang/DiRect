...
namespace WorkFlows {
    ...
    public partial class MenuWorkFlow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(MenuWorkFlow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(MenuWorkFlow));
        ...
        private string FindResource() {
            string[] resources = typeof(MenuWorkFlow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".MenuWorkFlow.g.xaml") || resource.Equals("MenuWorkFlow.g.xaml"))) {
                    return resource;
                }
            }
