...
namespace WorkFlows {
    ...
    public partial class RecordWorkFlow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(RecordWorkFlow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(RecordWorkFlow));
        ...
        private string FindResource() {
            string[] resources = typeof(RecordWorkFlow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".RecordWorkFlow.g.xaml") || resource.Equals("RecordWorkFlow.g.xaml"))) {
                    return resource;
                }
            }
